...
public class BuyProductViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public BuyProductViewHolder(View itemView) {
        super(itemView);
    ...
    public void onClick(View v) {
        ...
        if (appCompatActivity instanceof NavigationActivity) {
            Intent intent = Product_Detail_Activity.NewIntent(appCompatActivity,
                    mProduct.getProductUid(), mProduct.getProductTitle(),
                    mProduct.getProductDescription(), mProduct.getMinBidAmount(),
                    mProduct.getProductType(), mProduct.getPhotoUrl(), true);
